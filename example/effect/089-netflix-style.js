BL.register({
  id: '089',
  name: '089 Netflix style text animation with CSS',
  kind: 'visual',
  group: 'Visual 数据集特效',
  order: 89,
  src: 'Netflix style text animation with CSS · CodePen',
  css: `
...
/* 恢复颜色: Netflix 品牌红, 保留 text-shadow 阴影效果 */
:host .bl-wrap .netflix-txt,
:host .bl-wrap .netflix-txt .bl-char {
  color: #e90418 !important;
  -webkit-text-fill-color: #e90418 !important;
}
/* 停止循环动画以保证逐字露出时文字稳定可见 */
:host .bl-wrap .netflix-txt { animation: none !important; opacity: 1 !important; }
...
`,
  html: `<div class="netflix-txt">{{LETTERS}}</div>`,
