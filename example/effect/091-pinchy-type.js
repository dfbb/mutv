BL.register({
  id: '091',
  name: '091 Pinchy Type with CSS text-shadow',
  kind: 'visual',
  group: 'Visual 数据集特效',
  order: 91,
  src: 'Pinchy Type with CSS text-shadow · CodePen',
  css: `
...
.pinchy {
  ...
  font: 100 8vmin/1 Alegreya Sans;
  letter-spacing: 20px;
  text-align: center;
  color: sienna;
}
...
/* 恢复颜色 */
:host .bl-wrap .pinchy,
:host .bl-wrap .pinchy .bl-char {
  color: sienna !important;
  -webkit-text-fill-color: sienna !important;
}
...
`,
  html: `<h1 class="pinchy">{{LETTERS}}</h1>`,
