BL.register({
  id: '094',
  name: '094 Long Shadow Gradient Mixin',
  kind: 'visual',
  group: 'Visual 数据集特效',
  order: 94,
  src: 'Long Shadow Gradient Mixin · CodePen',
  css: `
...
/* 恢复颜色:原始白色文字(长投影由 text-shadow 提供,未被覆盖) */
:host .bl-wrap .text-longshadow,
:host .bl-wrap .text-longshadow .bl-char {
  color: #fff !important;
...
`,
  ...
  html: `<h1 class="text-longshadow">{{LETTERS}}</h1>`
});
